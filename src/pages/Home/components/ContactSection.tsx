...
export function ContactSection() {
  ...
  return (
    <section id="work-with-me" className="py-24 bg-brand-background/20 relative">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl" ref={ref}>
        ...
        >
          <Card className="bg-neutral-900/50 backdrop-blur-sm border-brand-500/20 rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-neutral-800 border-brand-500/20 text-white focus:border-brand-500"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-neutral-800 border-brand-500/20 text-white focus:border-brand-500 min-h-32"
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-4">
                <Button
                  type="submit"
                  className="flex-1 bg-brand-500 hover:bg-brand-600 text-white rounded-full"
                >
