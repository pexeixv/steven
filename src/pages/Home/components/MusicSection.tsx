        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            <h2 className="mb-6 text-4xl font-bold text-white lg:text-5xl">
              Music carved with <span className="text-brand-500">emotion</span>
            </h2>
          ...
          >
            ...
            <div className="absolute w-64 h-64 rounded-full -right-8 -bottom-8 bg-brand-500/10 blur-3xl"></div>
          </motion.div>
        </div>
      </div>
    </section>
